...
\uwds is specifically inspired geometric and temporal reasoner like {\sc Spark}
...
cognitive toolkits like KnowRob (as found in OpenEASE~\ref{beetz2015open}).
...
Other libraries, like QSRLib~\ref{gatsoulis2016qsrlib}, that implement
