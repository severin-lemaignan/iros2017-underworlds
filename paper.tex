...
The scenario consists of a number of \uwds clients that communicate with each other in order to provide an updated virtual representation to the operator. As seen in Figure \ref{fig|l2torexample}, the user interacts with some physical     
\begin{figure}
    \centering
